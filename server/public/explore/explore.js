...
let favoriteIcon = document.querySelectorAll(
  ".product-icons > .add-to-favorite > span"
);
let cartWishlistArea = document.querySelector(
  ".shopping-cart-wrap .cart-wishlist-area"
);
...
let shoppingCartArea = document.querySelector(
  ".shopping-cart-area .shopping-cart-wrap"
);
let cartContentArea = document.querySelector(
  ".shopping-cart-wrap .cart-contents-area"
);
...
let totalBuyingItemsWeight = document.querySelector(
  ".calculate-total-weight p span"
);
